<script type="text/javascript">
                ...
                t = $("#mytable").DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            "data": "idunit",
                            "orderable": false
                        },{"data": "idunit"},{"data": "nama_unit"},{"data": "alamat"},{"data": "telepon"},{"data": "status"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
           ...
           $(document).on('submit', '#form', function(event) {
            ...
            $.ajax({
                url: "<?php echo base_url('unit/json_form'); ?>",
                method: 'POST',
            ...
            function edit_data(id){
                $("#myModalLabel").text("Ubah Tbl_unit");
                $("#btn_simpan").attr("id", "btn_ubah");
                $("#btn_ubah").text("Ubah");
                $("[name=idunit]").attr("readonly", true);
                $.ajax({
                    url: "<?php echo base_url('unit/json_get'); ?>",
                    type: "POST",
                    data: {
                        id: id
                    },
                    dataType: "json",
                    success: function(data) {
                            $("#ModalaForm").modal("show");$("[name='idunit']").val(data.idunit);
...
$("[name='status']").val(data.status);
            ...
            function clear_data(){
                $("[name=idunit]").attr("readonly", false);
